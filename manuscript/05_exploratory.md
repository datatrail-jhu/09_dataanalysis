...
![Dataset on 120 years of Olympics history on athletes and results](images/05_exploratory/05_dataanalysis_exploratory-4.png)
...
![Importing data using `read_csv()`](images/05_exploratory/05_dataanalysis_exploratory-5.png)

As we learned before, we can use the package `skimr` to take a look at the data. 

![Using the skimr package to have a summary of the data](images/05_exploratory/05_dataanalysis_exploratory-6.png)
...
![We have different types of variables in our data](images/05_exploratory/05_dataanalysis_exploratory-7.png)
...
![There are some missing values in the data](images/05_exploratory/05_dataanalysis_exploratory-8.png)
...
![There is an outlier in the Age variable](images/05_exploratory/05_dataanalysis_exploratory-9.png)
...
![Histogram of the variable Age](images/05_exploratory/05_dataanalysis_exploratory-10.png)
...
![Boxplot of the variable Age for male and female individuals](images/05_exploratory/05_dataanalysis_exploratory-11.png)
...
![Wrangling data to find the share of female athletes over time](images/05_exploratory/05_dataanalysis_exploratory-12.png)
...
![Plot of the share of female athletes over time](images/05_exploratory/05_dataanalysis_exploratory-13.png)
...
![Creating a variable that shows whether the athlete has a medal or not](images/05_exploratory/05_dataanalysis_exploratory-15.png)

And now, we use the following code to create the boxplot.

![Boxplot for the relationship between height and having won a medal](images/05_exploratory/05_dataanalysis_exploratory-16.png)
