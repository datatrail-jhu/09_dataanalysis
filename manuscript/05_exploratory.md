...
![Boxplot of the variable Age for male and female individuals](images/05_exploratory/01_dataanalysis_exploratory-10.png)
...
![Wrangling data to find the share of female athletes over time](images/05_exploratory/01_dataanalysis_exploratory-11.png)
...
![Plot of the share of female athletes over time](images/05_exploratory/01_dataanalysis_exploratory-12.png)
...
![Creating a variable that shows whether the athlete has a medal or not](images/05_exploratory/01_dataanalysis_exploratory-14.png)

And now, we use the following code to create the boxplot.

![Boxplot for the relationship between height and having won a medal](images/05_exploratory/01_dataanalysis_exploratory-15.png)
