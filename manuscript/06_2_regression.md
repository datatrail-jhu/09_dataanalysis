...
{points:3}
? Within the same course on swirl: `DataTrail Data Analysis`, navigate to the lesson `L07 Linear Regression Q02 Swirl`. Do this swirl module! Once complete, paste the code provided at the end of the swirl module here.
